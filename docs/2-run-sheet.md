...
> contradict us. If he only confirms what exists, we walk away with nothing for report §5.c. When he says something
> that clashes with the build, *write it down as a clash* — do not explain the build at him. Explaining comes after
> minute 85, if at all.
...
including us. Quantity first. If he stalls around minute 20, prompt with a *phase*, never with an event: "what about
...
his words**, not ours — if the group is "comm", it is called comm.
...
Every time he uses a word we have not written down, or uses one of ours to mean something different. Both meaning
...
## While he is here, unrelated to the wall

- [ ] One **oversell story** and one **payment-confusion story**, told as incidents. These are the two hard rules,
      in his voice.
- [ ] Permission to quote him by name in the report, and to use the board photo.
...
- [ ] Merge the new terms into [2-glossary.md](2-glossary.md), spelled the way he spells them.
